...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-16 18:49`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/04319a7d-c054-4558-bb5e-5a0ed8a74efa.git
$ cd 04319a7d-c054-4558-bb5e-5a0ed8a74efa
```
